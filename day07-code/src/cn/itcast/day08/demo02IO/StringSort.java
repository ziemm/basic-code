...
public class StringSort {
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader br = new BufferedReader(new FileReader("day07-code\\resources\\in.txt"));
        BufferedWriter bw = new BufferedWriter(new FileWriter("day07-code\\resources\\out.txt"));
